...
G.FX_PRESETS = [
  ...
  {name: "Crescent slash", desc: "CrescentWave: R 42, span 170, width 6.5, 5 ticks, 0.4 px/tick",
   effects: [{prim: "arc", name: "Crescent slash", anchor: "figure", offset: [0, 0], life_ticks: 5,
     motion: {kind: "travel", aim: "target", speed: 0.4}, color: {mode: "palette", flow_speed: 0.008},
     params: {radius: 42, span: 170, width: 6.5, tail: 0.95, segs: 16, grow: 0.85, core_alpha: 0.7, core_width: 0.3, orient: "motion"}}]},
  {name: "Through crescent", desc: "Through-slash: 10 px/tick so the arc cuts through the target",
   effects: [{prim: "arc", name: "Through crescent", anchor: "figure", life_ticks: 5,
  ...
  {name: "Cone bolt", desc: "Projectile: PROJ_SPEED 8, radius 3, 220 ticks, 5-point trail",
   effects: [{prim: "sprite", name: "Cone bolt", anchor: "haR", life_ticks: 220, emit: {count: 3, fan_deg: 90},   // SHOT_CONE_ANGLES ±45
  ...
  {name: "Zigzag bolt", desc: "ZigzagProjectile: amplitude 55, frequency 0.18, hot streak",
   effects: [{prim: "sprite", name: "Zigzag bolt", anchor: "haR", life_ticks: 220, emit: {count: 2},
  ...
  {name: "Homing orb", desc: "HomingProjectile: 0.5 × PROJ_SPEED with the pulsing halo",
   effects: [{prim: "sprite", name: "Homing orb", anchor: "haR", life_ticks: 220,
  ...
  {name: "Rich beam", desc: "RichBeamProjectile: segmented, glowing, detaches and withers",
   effects: [{prim: "beam", name: "Rich beam", anchor: "haR", life_ticks: 150, blend: "additive",
  ...
  {name: "Held beam", desc: "A beam held from the hand, growing along the aim",
   effects: [{prim: "beam", name: "Held beam", anchor: "haR", blend: "additive",
  ...
  {name: "Petal orbs", desc: "Petals: 3 orbs, hover 46 px, 70°/s, radius 8, #fbeef3",
   effects: [{prim: "sprite", name: "Petal orbs", anchor: "figure", emit: {count: 3},
